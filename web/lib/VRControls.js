...
THREE.VRControls = function ( object, fakeobject, onError ) {
	...
	function gotVRDevices( devices ) {
		...
		console.log("Found " + vrInputs.length + " devices.");
	...
	this.update = function () {
		...
		for ( var i = 0; i < vrInputs.length; i ++ ) {
			...
			if ( state.orientation !== null && state.orientation.x != 0.0 ) {
				object.quaternion.copy( state.orientation );
			}

			if ( state.position !== null && state.position.x != 0.0) {
